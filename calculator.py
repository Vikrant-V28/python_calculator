...
def cal():
    ...
    cal_button_bg = '#E37112'
    caleq_button_bg = '#CC3146'
    calpw_button_bg = '#093D52'
    calpnt_button_bg = '#09523E'
    num_button_bg = '#58D68D'
    other_button_bg = '#56DC2C'
    text_fg = '#FFFFFF'
    ...
    button13 = num_button(text='.', bg=calpnt_button_bg,
    ...
    button17 = Button(root, text='=', fg=text_fg, bg=caleq_button_bg, padx=10, pady=3,
                      command=lambda: calc(entry), activebackground=button_active_bg)
    button17.grid(row=5, column=3, pady=5)

    button18 = Button(root, text='^', fg=text_fg, bg=calpw_button_bg, padx=10, pady=3,
                      command=lambda: get_input(entry, '**'))
    button18.grid(row=5, column=2, pady=5)

    def quit():
        exit['command'] = root.quit()
    exit = Button(root, text='Quit', fg='white', bg='black',
                  command=quit, height=1, width=6)
